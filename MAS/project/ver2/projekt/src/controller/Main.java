...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Discount discount1 = new Discount("środy z Iluzjon", "Promocja aktywna tylko w środy", 10);
...
//        );
        ...
        Ticket ticket = new OneTimeTicket(false, TicketType.SCHOOL, emp, false, seat, reservation);
        Ticket ticket2 = new LongTermTicket(false, TicketType.NORMAL, LocalDate.of(2019, 06, 11), LocalDate.of(2019, 07, 11), emp);
